...
## Import all scripts ##
from AADatasets import import_mnist, import_dogcat, pre_processing, make_pre_train_classes
...
if __name__ == '__main__':
	...
	run_experiment('CatDog','mnist', limit=1000, img_size_x=64, img_size_y=64, demension=1, Batch_size=10, Epochs=5, norm=True, split=0.20)
